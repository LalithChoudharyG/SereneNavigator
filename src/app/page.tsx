    ...
    <main id="main-content" className="bg-[#fef8f4] text-[#1d1b19]">
      <section className="relative overflow-hidden bg-gradient-to-br from-[#fef8f4] to-[#f9f2ee] px-6 pb-20 pt-10 sm:px-8 lg:px-8 lg:pb-24 lg:pt-12">
        <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-2">
          <div className="z-10">
            <span className="font-[var(--font-body)] inline-flex rounded-full bg-[#93e6fe]/30 px-3 py-1 text-[11px] font-bold uppercase tracking-[0.18em] text-[#00687b]">
              Expert travel intelligence
            </span>

            <h1 className="mt-6 max-w-3xl font-[var(--font-headline)] text-5xl font-extrabold leading-[1.1] tracking-[-0.04em] text-[#00505e] sm:text-6xl lg:text-7xl">
              Trusted destination guidance for every traveler.
            </h1>

            <p className="mt-8 max-w-xl font-[var(--font-body)] text-lg leading-8 text-[#3f484b] sm:text-xl">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <Link
                href="/destination"
                className="font-[var(--font-body)] inline-flex items-center justify-center rounded-xl bg-[#693f00] px-8 py-4 text-base font-bold text-white shadow-xl transition hover:scale-[1.01] hover:shadow-[#693f00]/20 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#ffb865]/50 active:scale-[0.98]"
              >
                Browse Destinations
              </Link>
              ...
              <Link
                href="/plan"
                className="font-[var(--font-body)] inline-flex items-center justify-center rounded-xl bg-[#e7e1dd] px-8 py-4 text-base font-bold text-[#00505e] transition hover:bg-[#dfd9d5] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#489fb5]/40 active:scale-[0.98]"
              >
                Start Planning
              </Link>
            </div>

            <div className="mt-10 flex items-center gap-4 font-[var(--font-body)] text-sm font-medium text-[#6f797c]">
          ...
          <div className="relative">
           <div className="aspect-square w-full max-w-[580px] rotate-3 overflow-hidden rounded-[2.5rem] border-6 border-white shadow-[0_30px_80px_rgba(29,27,25,0.18)] lg:ml-auto">
              <img
            ...
            <div className="absolute -bottom-8 left-0 max-w-xs rounded-2xl bg-white p-6 shadow-[0_12px_32px_rgba(29,27,25,0.06)]">
              <div className="mb-3 flex items-center gap-3">
                ...
                <span className="font-[var(--font-body)] font-bold text-[#00505e]">
                  {heroAlert
              ...
              <p className="font-[var(--font-body)] text-sm leading-6 text-[#3f484b]">
                {heroAlert
      ...
      <section className="border-y border-[#16697a]/10 bg-[#ede7e3] py-8">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-8 px-6 opacity-70 grayscale transition hover:grayscale-0 md:flex-row sm:px-8 lg:px-8">
          <p className="font-[var(--font-body)] text-xs font-bold uppercase tracking-[0.2em] text-[#6f797c]">
            Verified data sources
          </p>

          <div className="flex flex-wrap items-center justify-center gap-8 font-[var(--font-headline)] text-lg font-extrabold italic text-[#6f797c] sm:gap-12">
            <span>WHO</span>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24 sm:px-8 lg:px-8">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="rounded-2xl bg-white p-8 shadow-[0_12px_32px_rgba(29,27,25,0.06)]">
            ...
            <h2 className="font-[var(--font-headline)] text-xl font-bold text-[#00505e]">
              Health Protocol
            </h2>
            <p className="mt-3 font-[var(--font-body)] text-sm leading-7 text-[#3f484b]">
      ...
      <section className="bg-[#f9f2ee] px-6 py-24 sm:px-8 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <h2 className="font-[var(--font-headline)] text-4xl font-extrabold text-[#00505e]">
                Critical Updates
              </h2>
              <p className="mt-4 font-[var(--font-body)] text-[#3f484b]">
            ...
            <Link
              href="/destination"
              className="font-[var(--font-body)] inline-flex items-center gap-2 text-sm font-bold text-[#00687b] transition hover:underline"
            >
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {recentAlerts.length === 0 ? (
              <div className="rounded-2xl bg-white p-6 shadow-[0_12px_32px_rgba(29,27,25,0.06)] md:col-span-3">
                <p className="font-[var(--font-body)] text-sm leading-7 text-[#3f484b]">
              ...
              recentAlerts.map((alert) => (
                ...
                >
                  <div className="mb-6 flex items-start justify-between gap-4">
                    <span
                      className={`font-[var(--font-body)] rounded-full px-3 py-1 text-[10px] font-black uppercase tracking-[0.18em] ${severityStyles(
                        alert.severity
                      )}`}
                    >
                      {alert.severity}
                    ...
                    <span className="font-[var(--font-body)] text-xs font-medium text-[#6f797c]">
                      {alert.startDate ?? "Recent"}
                    </span>
                  </div>

                  <h3 className="font-[var(--font-headline)] text-lg font-bold text-[#1d1b19] transition group-hover:text-[#00505e]">
                  ...
                  <div className="mt-6 flex items-center justify-between border-t border-[#16697a]/10 pt-6">
                    <span className="font-[var(--font-body)] text-xs font-bold uppercase tracking-[0.14em] text-[#00505e]">
                    ...
                    <Link
                      ...
                      className="font-[var(--font-body)] text-xs font-bold text-[#6f797c] transition hover:text-[#00505e]"
                    >
                      Open
                    </Link>
                  </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24 sm:px-8 lg:px-8">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl font-[var(--font-body)] text-[#3f484b]">
        ...
        <div className="relative mt-20 grid gap-16 md:grid-cols-3">
          ...
          <div className="text-center">
            <div className="mx-auto mb-8 flex h-20 w-20 items-center justify-center rounded-full bg-[#e7e1dd] shadow-lg">
              <span className="font-[var(--font-headline)] text-2xl font-bold text-[#00505e]">
                1
              </span>
            </div>
            <h3 className="font-[var(--font-headline)] text-xl font-bold text-[#00505e]">
              Search
            </h3>
            <p className="mt-4 px-4 font-[var(--font-body)] text-sm leading-7 text-[#3f484b]">
      ...
      <section className="px-6 pb-24 sm:px-8 lg:px-8">
        <div className="mx-auto max-w-7xl overflow-hidden rounded-[2.5rem] bg-[#00505e] p-12 text-center sm:p-16">
          ...
          <h2 className="font-[var(--font-headline)] text-4xl font-bold leading-tight text-white sm:text-5xl">
            Ready to explore the world
            <br className="hidden md:block" /> with total peace of mind?
          </h2>

          <p className="mx-auto mt-8 max-w-2xl font-[var(--font-body)] text-lg leading-8 text-[#8ad1e4]">
          ...
          <div className="mt-10 flex flex-col justify-center gap-6 sm:flex-row">
            <Link
              href="/destination"
              className="font-[var(--font-body)] inline-flex items-center justify-center rounded-xl bg-[#693f00] px-10 py-4 text-lg font-bold text-white shadow-2xl transition hover:bg-[#7d4a00]"
            >
              Get Started
            </Link>
            ...
            <Link
              href="/about"
              className="font-[var(--font-body)] inline-flex items-center justify-center rounded-xl border border-white/20 bg-white/10 px-10 py-4 text-lg font-bold text-white backdrop-blur-md transition hover:bg-white/20"
            >
              About our sources
            </Link>
          </div>
